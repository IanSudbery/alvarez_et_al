...
# condition and batch.
# 1) Performs a Wald Test for condition accounting for batch. All results are outputted without outlier detection (regions
...
# 3) Gets regions which are significant for MM vs. PC condition 
...
#   -pdaj_threshold: Only regions where the padj of the Wald test < pdaj_threshold
#       will be outputted.
...
pdaj_threshold = 0.1
counts_matrix_file = "tag_counts.dir/pan_raw_tag_counts.donors_collapsed.tsv.gz"
coldata_file = "tag_counts.dir/pan_raw_tag_counts.donors_collapsed.col_data.tsv"
de_res_batch_condition_output_file = "DE.dir/all_pan_atac_regions.tsv.gz"
sign_batch_MM_vs_PC_file = "DE.dir/sign_pan_atac_regions.tsv.gz"
output_heatmaps = "DE.dir/pan_sign_Wald_test.png"
...
# Subset to remove cell lines
coldata_df <- coldata_df[coldata_df$condition != "Cell_line",]

# Subset count matrix to only samples in the coldata
...
res_batch_condition=as.data.frame(results(dds, cooksCutoff=FALSE))
