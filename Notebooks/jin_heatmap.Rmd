---
title: 'Clustering Jin et al samples with ours and replotting heatmap. '
output:
  html_document:
    df_print: paged
---
...
mat <- mat[, !(col_data$condition == "ND" & col_data$study == "Jin et al")]
col_data <- col_data[!(col_data$condition == "ND" & col_data$study == "Jin et al"),]
...
png("../Figures/jin_et_heatmap_no_ND.png", height=3, width=5, units="in", res = 300)
